...
namespace ImageMounter.IO
{
    ...
    {
        public static WriteFilterStatistics Initialize()
        {
            return new WriteFilterStatistics()
            {
                Version = System.Convert.ToUInt32(PinnedBuffer<WriteFilterStatistics>.TypeSize)
            };
        }
        ...
        // '
        public bool IgnoreFlushBuffers
        {
            get
            {
                return (Flags & 0x10000U) == 0x10000U;
            }
        }
        ...
        // ' media.
        // '
        public bool FakeNonRemovable
        {
            get
            {
                return (Flags & 0x1000000U) == 0x1000000U;
            }
        }
        ...
        // '
        public long AllocationTableSize
        {
            get
            {
                return System.Convert.ToInt64(AllocationTableBlocks) << DiffBlockBits;
            }
        }
        ...
        // '
        public long UsedDiffSize
        {
            get
            {
                return System.Convert.ToInt64(LastAllocatedBlock) << DiffBlockBits;
            }
        }
        ...
        // '
        public int DiffBlockSize
        {
            get
            {
                return 1 << DiffBlockBits;
            }
        }
